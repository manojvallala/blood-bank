...
public class Hospital extends Donor {
	...
	void hospitalEnqueue() {
		...
		System.out.println("On a scale of 1 to 5, Enter the urgency of Blood required (Please refer the following parameters):");
	...
	void hospitalDequeue() {
		...
		if (flag == 1) {
			if (front.hosp_name.equals(h_name)) {
				...
				System.out.println("Your request cannot be proceeded right now as there are other urgent cases in queue");
			}
		} else if (flag == 0) {
